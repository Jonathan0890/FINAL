...
const transactions = [/* ... (mantenemos el mismo array de transacciones) ... */]
                            ...
                            <tr key={transaction.id} className="hover:bg-gray-50 border-t">
                                ...
                                <td className="p-4 relative">
                                    <button
                                        ...
                                        onClick={() => setIsMenuOpen(isMenuOpen === transaction.id ? null : transaction.id)}
                                    >
                                        <MoreHorizontal className="h-4 w-4" />
                                    </button>

                                    {isMenuOpen === transaction.id && (
